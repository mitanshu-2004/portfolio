...
export default function Experience() {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case "Active":
        return "bg-green-500/20 text-green-400 border-green-500/50 shadow-green-500/20"
      case "Current":
        return "bg-purple-500/20 text-purple-400 border-purple-500/50 shadow-purple-500/20"
      case "Foundation":
