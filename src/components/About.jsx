    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="text-gray-300 text-lg leading-relaxed max-w-3xl mx-auto mt-4">
          <p>
            I am a software developer and robotics engineer with experience in web development, AI tools, and robotic
            systems. I have built applications using MERN, FastAPI, and Firebase, and worked on AI models with
            NVIDIA NeMo and Sentence Transformers. On the robotics side, I have designed and programmed robotic
            arms and legged robots using ROS/ROS2, MoveIt, and Gazebo, and integrated them with custom web
            interfaces for real-time control. My work spans both software and hardware, and I have gained practical
            skills through internships, hackathons, and robotics competition
